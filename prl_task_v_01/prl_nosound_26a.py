...
# Map the self-stranger argument to the corresponding description for output file writing
self_description_map = {
    "self": "subject_portrait",
    "stranger": "stranger_portrait",
}
