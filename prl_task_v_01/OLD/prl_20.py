...
# Function to display mood slider
def display_mood_slider():
    ...
    slider_value_changed = False  # Track if the slider value has changed
    ...
    def check_slider_changed():
        nonlocal slider_value_changed  # Use nonlocal to modify the outer variable
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.USEREVENT:
                ...
                if event.user_type == pygame_gui.UI_BUTTON_PRESSED:
                    if event.ui_element == continue_button and slider_value_changed:
                        running = False
