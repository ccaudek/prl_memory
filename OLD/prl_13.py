...
def display_images_and_get_response(orange_img, white_img, epoch):
    ...
    return orange_pos, key_pressed, reaction_time, chosen_image
...
for epoch in range(n_epochs):
    ...
    for trial in range(trials_per_epoch):
        ...
        orange_pos, key_pressed, reaction_time, chosen_image_file = display_images_and_get_response(orange_img, white_img, epoch)
        ...
        trial_data = [{
            ...
            "Chosen Image": chosen_image_file,
            "Most Rewarded Stimulus in Epoch": 'Orange' if epoch % 2 == 0 else 'White'
        }]
        experiment_data.extend(trial_data)
